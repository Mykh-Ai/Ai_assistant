...
_REGISTRY: tuple[ProductTruthCapability, ...] = (
    ...
    _capability(
        ...
        domain='contacts',
        status=ProductTruthStatus.PARTIAL,
        summary_for_user='Supports confirmation-gated manual/document contact intake and, when enabled for the active workspace, official Slovak company search by name or IČO with bounded candidate selection and official-data prefill.',
        current_limitations=(
            ...
            'The official RPO source does not provide every required field; missing DIČ is typed manually, email/IBAN/contact person are normally manual, and IČ DPH is never inferred.',
