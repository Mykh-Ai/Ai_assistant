...
_REGISTRY: tuple[ProductTruthCapability, ...] = (
    ...
    _capability(
        ...
        current_limitations=(
            ...
            'An explicitly named customer may be resolved from a noisy, transliterated, or Cyrillic reference only against current tenant-scoped contacts; Python then prefilters by trusted contact id and does not save an alias.',
