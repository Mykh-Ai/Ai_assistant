...
_REGISTRY: tuple[ProductTruthCapability, ...] = (
    ...
    _capability(
        ...
        domain='contacts',
        status=ProductTruthStatus.PARTIAL,
        summary_for_user='Supports confirmation-gated manual/document contact intake, deterministic official Slovak company search by name or IČO when enabled for the active workspace, and an optional confirmation-gated 14-day registry monitor for eligible saved contacts.',
        current_limitations=(
            ...
            'The periodic monitor is separately disabled by default, requires an exact eight-digit IČO and active owner authorization, and may maintain saved contacts in inactive profiles; it never updates a contact without an explicit proposal-button confirmation.',
