...
_REGISTRY: tuple[ProductTruthCapability, ...] = (
    ...
    _capability(
        ...
        domain='work_hours',
        status=ProductTruthStatus.PARTIAL,
        summary_for_user='Records open/close work days, preview-confirmed manual time ranges or duration-only totals, generates a monthly Excel work-time report, and can delete one selected month of stored work-time rows after confirmation.',
        current_limitations=(
            ...
            'Manual ranges, duration-only totals, ambiguous extracted exact values, and monthly deletion require preview confirmation before save/delete.',
        ...
        safe_next_steps=(
            'Say zacinam pracovny den, zatvor den o 17:00, pracoval som dnes od 5:30 do 17:00, dnes 10 hodin, vytvor vykaz hodin za jun 2026, or vymaz dochadzku za jul 2026.',
        ),
        customization_allowed=True,
        requires_setup=True,
        setup_state_keys=('authorized_user',),
