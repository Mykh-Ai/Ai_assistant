...
## Unreleased
- Fixed access approval for one unambiguous migration-created inactive owner membership: approval now atomically validates supplier/workspace ownership, reactivates the membership, restores active selection, creates no business profile data, and rolls back fully on multiple or contradictory ownership.
